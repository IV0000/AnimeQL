...
public class PageQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query Page($perPage: Int) { Page(perPage: $perPage) { __typename mediaList { __typename media { __typename averageScore coverImage { __typename medium } description episodes genres title { __typename romaji english } } } } }"#
    ))
